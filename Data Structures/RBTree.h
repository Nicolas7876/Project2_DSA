...
// Slightly modified for intended use
//
//  RedBlackTree.h
//  red-black-tree
//
...
struct Node {
    ...
    explicit Node(std::string val, T val2) : data(val), value(val2), color(RED), left(nullptr), right(nullptr), parent(nullptr) {}
};
...
//    delete a node
    ...
    void printHelper(Node<T>* root, int space) {
...
public:
    ...
    // insert a node
    void insert(std::string val, T val2) {
